...
type APIServiceExportRequestSpec struct {
	...
	// Foo is an example field of APIServiceExportRequest. Edit apiserviceexportrequest_types.go to remove/update
...
// APIServiceExportRequest is the Schema for the apiserviceexportrequests API.
type APIServiceExportRequest struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   APIServiceExportRequestSpec   `json:"spec,omitempty"`
	Status APIServiceExportRequestStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// APIServiceExportRequestList contains a list of APIServiceExportRequest.
...
func init() {
	SchemeBuilder.Register(&APIServiceExportRequest{}, &APIServiceExportRequestList{})
}
