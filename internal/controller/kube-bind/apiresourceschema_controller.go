...
func (r *APIResourceSchemaReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *APIResourceSchemaReconciler) SetupWithManager(mgr ctrl.Manager) error {
